...
const putResultsPAR = "https://axfaxcymae5t.objectstorage.eu-amsterdam-1.oci.customer-oci.com/p/MQqFaBNRqR23mp4c58wiqRZMveEvfV-SIFi4-W-gMaK6L1NXHvnyVtMN-Y_MaBKh/n/axfaxcymae5t/b/conclusion-assets/o/onstage-survey/results/anonymous/" ;
export async function saveUserDataUnauthenticated(data) {
...
// Add/update the lastModified timestamp
    ...
    const actualPutEndpoint = putResultsPAR + `onstage-survey-result-${Date.now()}-${randomNumber}.json`;
    try {
